 ...
 *
 * @Action(
 *   id = "activar_personalizacion_action",
 *   label = @Translation("Action Example: A basic example action that does nothing"),
 *   type = "media"
 * )
 */
class activar_personalizacion extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  public function execute($entity = NULL) {
    ...
    if( $entity->hasField('field_lv_customize_cinemagraph') ){
      $entity->field_lv_customize_cinemagraph->value = 1;
      $entity->save();

      $this->messenger()->addMessage($this->t('Se ha activado la personalización correctamente'));
    }
